...
const angebot = "/img/angebot-1508.webp";
const profisport = "/img/strength-club-1824.webp";

export function PerformanceClubBlock() {
  return (
    <section className="grid grid-cols-1 lg:grid-cols-2 border-b border-foreground/10">
      ...
      <div className="flex flex-col justify-center px-8 lg:px-16 py-20">
        ...
        <p className="mt-8 max-w-lg text-muted-foreground">
          Willkommen im JuklHealth Performance Club, inmitten von Dornbirn.
          Funktionelles Training, erstklassige Physiotherapie und ein Team aus
          Trainern, Sportwissenschaftlern und Physiotherapeuten.
        </p>
...
export function AngebotImage() {
  return (
    <section className="relative w-full h-[40vh] min-h-[240px] sm:h-[55vh] lg:h-[80vh] overflow-hidden border-b border-foreground/10">
      <SmartImage
        src={angebot}
        alt="Create the best version of yourself"
        className="absolute inset-0 w-full h-full object-cover"
        sizes="100vw"
      />
  ...
  return (
    <section className="grid grid-cols-1 lg:grid-cols-2 border-b border-foreground/10">
      <div className="flex flex-col justify-center px-8 lg:px-16 py-20 order-2 lg:order-1">
        ...
        <p className="mt-8 max-w-lg text-muted-foreground">
          Deine Erfolgsgeschichte beginnt hier. Wir begleiten Leistungssportler,
          ambitionierte Sportler und Profis auf ihrem Weg. Dein Erfolg ist unser
          Fokus.
        </p>
        <div className="mt-10">
          <Link
