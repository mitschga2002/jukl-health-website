...
export function Credibility() {
  return (
    <section className="bg-foreground text-background py-24 px-6 lg:px-12 grid grid-cols-1 lg:grid-cols-2 gap-20 lg:gap-24">
      <div className="relative">
        ...
        <div className="absolute -bottom-6 -right-6 bg-primary text-primary-foreground p-10 lg:p-12 hidden lg:block">
          ...
          <div className="text-[11px] mt-3 uppercase tracking-[0.22em]">
            Jahre Erfahrung
          </div>
        </div>
      </div>
      <div className="flex flex-col justify-center">
        ...
        <div className="space-y-6 text-background/70 max-w-lg">
          <p>
            Geleitet von Experten aus den Bereichen Sportwissenschaft und
            Physiotherapie, bietet der JuklHealth Performance Club eine ruhige,
            klinische Umgebung für nachhaltige Entwicklung.
          </p>
          <p>
            Wir arbeiten mit evidenzbasierten Methoden und modernem Equipment,
            um Ihre Ziele präzise und sicher zu erreichen.
          </p>
          <Link
            to="/team"
